...
const (
	// expectedSchemaVersion is the schema version for PostgreSQL analytics.
...
// transaction.
func recordMigration(ctx context.Context, tx *sql.Tx, m migration) error {
	_, err := tx.ExecContext(ctx,
		`INSERT INTO usage_schema_migrations (version, description, applied_at) VALUES ($1, $2, $3)`,
